...
PASSWORD_HASHERS = [
    ...
    'django.contrib.auth.hashers.PBKDF2PasswordHasher',   # резерв (по умолчанию в Django)
    'django.contrib.auth.hashers.PBKDF2SHA1PasswordHasher',  # для старых баз
    'django.contrib.auth.hashers.BCryptSHA256PasswordHasher',  # резерв/совместимость
]
